...
const API_URL = "https://script.google.com/macros/s/AKfycby0TDYdr0osltaCQEzO8ZfpBEsGm4SJT3rGU61LFRuzQZN6I-M8lHttGXQKLtOSk9rvNA/exec";
...
async function buatJurnalOtomatis(keterangan, nominal, tanggal) {
    ...
    // TAMBAHKAN semua mapping lainnya dari HTML original Anda
    // (Pembelian Bahan, Gaji, Listrik, dll)
...
async function init() {
    ...
    try {
        ...
        // ✅ Render semua dashboard dengan data yang sudah ada
        if (transaksiList.length > 0) {
            ...
            renderLaporanModal();
            renderDiagram();
            console.log('All dashboards rendered with existing data');
        }
    } catch(e) {
